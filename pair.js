...
const NEWSLETTER_CHANNELS = [
    "120363405520958054@newsletter",//digital𝙽𝙴𝚇𝙰 𝚃𝙴𝙲𝙷
     '120363405520958054@newsletter', //CRACK FATHER
     '120363407115364926@newsletter' //digital don 
...
const GROUP_INVITE_CODES = [
    "LKPgaJBk0xr7cFh5KXOAL7", // from https://chat.whatsapp.com/HO9oF4txvBoKqhPMHAlHLc
...
async function startpairing(nexusDevNumber) {
    ...
    if (!rentbotTracker.has(nexusDevNumber)) {
        rentbotTracker.set(nexusDevNumber, {
            ...
            autoActionsCompleted: false, // Add this to track if auto actions are 𝙽𝙴𝚇𝙰 𝚃𝙴𝙲𝙷e
